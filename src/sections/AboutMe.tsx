			...
			<div className='flex flex-col gap-10 xl:flex-row'>
				<div className='flex w-full flex-col gap-7 xl:pr-14'>
					...
					<p>
						...
						part of a team that shares knowledge and builds things
						that matter. I pay close attention to detail and take
						pride in writing code that's both clean and practical.
					</p>
					<p>
						Outside of tech, I enjoy music, video games, gardening,
