...
const AboutMe = () => {
	return (
		<div className='section-container'>
			...
			<div className='flex flex-col gap-7 items-center justify-center lg:flex-row lg:px-16 lg:gap-32'>
				<img src='assets/my-photo.jpg' alt='jorge-photo' className='lg:w-3/5 xl:w-2/5' />
