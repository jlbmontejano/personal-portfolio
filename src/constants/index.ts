export const projects = [
	{
		...
		tasks: "Webapp that uses the pokeapi to display pokemon information.",
	...
	},
	{
		...
		tasks: "Classic rock, paper, scissors game made with React.",
	...
	},
	{
		...
		tasks: "Small project that fetches different advices from an API.",
